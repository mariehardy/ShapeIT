...
const carouselItems = [
  ...
  },
  {
    ...
    altText: "Slide 2",
    caption: "I personally loved workouts! At the beginning it was hard. But then little by little - I got used to it and started enjoying the transformation process (c) Olga"
  },
  {
    ...
    altText: "Slide 3",
    caption: "Shape It, Baby! Became my personal Moto. I will definetely recommend this app for anyone, who wants to become a better version of themselves (c) Marie"
  }
];
